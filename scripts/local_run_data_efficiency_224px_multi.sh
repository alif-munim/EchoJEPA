...
BASE_CFG="${REPO_DIR}/configs/eval/vitg-384/view/echojepa_view_classification_224px_multi.yaml"
TRAIN_FULL="${REPO_DIR}/data/csv/uhn_views_22k_train.csv"
VAL_CSV="${REPO_DIR}/data/csv/uhn_views_22k_val.csv"
...
#     run_training "uhn22k_multi_1pct_s${SEED}" "$SUBSET_CSV"
# done
...
for SEED in 1 2 3; do
    ...
    run_training "uhn22k_multi_10pct_s${SEED}" "$SUBSET_CSV"
done

# --- 100% Data (full dataset) ---
run_training "uhn22k_multi_100pct" "$TRAIN_FULL"
