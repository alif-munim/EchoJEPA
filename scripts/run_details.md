...
kinetics pretrain
```
python -m app.main --fname /home/sagemaker-user/user-default-efs/vjepa2/configs/train/vitl16/pretrain-mimic-224px-16f.yaml --devices cuda:0 cuda:1 cuda:2 cuda:3 cuda:4 cuda:5 cuda:6 cuda:7 2>&1 | tee echojepa-L-kinetics-pretrain.log
```

kinetics cooldown
```
python -m app.main --fname /home/sagemaker-user/user-default-efs/vjepa2/configs/train/vitl16/cooldown-mimic-224px-16f.yaml --devices cuda:0 cuda:1 cuda:2 cuda:3 cuda:4 cuda:5 cuda:6 cuda:7 2>&1 | tee echojepa-L-kinetics-cooldown.log
```
...
python -m evals.extract_embeddings \
    ...
    --data /home/sagemaker-user/user-default-efs/vjepa2/data/csv/a4c_b_lvef_test_224px_RAW.csv \
...
python -m evals.extract_embeddings \
    ...
    --data /home/sagemaker-user/user-default-efs/vjepa2/data/csv/a4c_b_lvef_test_224px_RAW.csv \
    --output embeddings/lvef/echojepa_l_embeddings.npz \
...
python -m evals.extract_embeddings \
    ...
    --data /home/sagemaker-user/user-default-efs/vjepa2/data/csv/a4c_b_lvef_test_224px_RAW.csv \
    --output embeddings/lvef/panecho_embeddings.npz \
    --devices cuda:0 cuda:1 cuda:2 cuda:3 cuda:4 cuda:5 cuda:6 cuda:7
...
python -m evals.extract_embeddings \
    ...
    --data /home/sagemaker-user/user-default-efs/vjepa2/data/csv/a4c_b_lvef_test_224px_RAW.csv \
    --output embeddings/lvef/echomae_l_embeddings.npz \
    --devices cuda:0 cuda:1 cuda:2 cuda:3 cuda:4 cuda:5 cuda:6 cuda:7
...
python -m evals.extract_embeddings \
    ...
    --data /home/sagemaker-user/user-default-efs/vjepa2/data/csv/a4c_b_lvef_test_224px_RAW.csv \
    --output embeddings/lvef/echoprime_embeddings.npz \
    --devices cuda:0 cuda:1 cuda:2 cuda:3 cuda:4 cuda:5 cuda:6 cuda:7
```
...
```
# (BEST) Clinical range (20-75%) for cleaner visualization
python data/plot_umap_lvef.py \
...
```
# (BEST) Very spread out
python data/plot_umap.py --n_neighbors 15 --min_dist 0.5 --spread 2.0 --output figures/umap_spread_test_v2.pdf --embeddings_dir embeddings
...
EchoJEPA-Large Inference
```
python -m evals.main --fname /home/sagemaker-user/user-default-efs/vjepa2/configs/inference/vitg-384/lvef/echonet-dynamic/echojepa_large.yaml --devices cuda:0 cuda:1 cuda:2 cuda:3 cuda:4 cuda:5 cuda:6 cuda:7 2>&1 | tee echojepa_large_echonet_dynamic.out
```
...
PanEcho Inference
```
python -m evals.main --fname /home/sagemaker-user/user-default-efs/vjepa2/configs/inference/vitg-384/lvef/echonet-dynamic/panecho.yaml --devices cuda:0 cuda:1 cuda:2 cuda:3 cuda:4 cuda:5 cuda:6 cuda:7 2>&1 | tee panecho_echonet_dynamic_da075.out
```
...
linear probe
```
python -m evals.main --fname configs/eval/vitg-384/view/echojepa_view_linear.yaml --devices cuda:0 cuda:1 cuda:2 cuda:3 cuda:4 cuda:5 cuda:6 cuda:7 2>&1 | tee echojepa-g-linear-view22k.log
```
