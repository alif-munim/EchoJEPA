...
Usage:
    ...
    python scripts/rebuttal/cardiac_trajectory.py \
...
def main():
    ...
    parser.add_argument("--output", default="scripts/rebuttal/samples/cardiac_trajectory.png")
    parser.add_argument("--output_npz", default="scripts/rebuttal/samples/cardiac_trajectory.npz",
