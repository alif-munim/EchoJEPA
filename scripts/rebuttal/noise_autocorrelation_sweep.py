...
Usage:
    python scripts/rebuttal/noise_autocorrelation_sweep.py \
        --test_csv data/csv/echonet_dynamic_test_local.csv \
        --models JEPA-IN21K-e100 \
        --device cuda:0 \
        --output scripts/rebuttal/samples/autocorr_JEPA_IN21K_e100.csv
    ...
    python scripts/rebuttal/noise_autocorrelation_sweep.py \
        ...
        --output scripts/rebuttal/samples/autocorr_BYOL_e100.csv &
    python scripts/rebuttal/noise_autocorrelation_sweep.py \
        --test_csv data/csv/echonet_dynamic_test_local.csv \
        --models MAE-L-e99 --device cuda:2 \
        --output scripts/rebuttal/samples/autocorr_MAE_e99.csv &
"""
...
def main():
    ...
    if args.output is None:
        args.output = "scripts/rebuttal/samples/noise_autocorrelation_results.csv"
