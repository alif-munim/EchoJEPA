...
Usage:
    python scripts/rebuttal/frame_shuffle_segmentation_extended.py \
...
def run_severity(encoder, decoder, dataloader, model_type, device, args):
    ...
    if args.output is None:
        args.output = f"scripts/rebuttal/samples/{args.label}_camus_severity.csv"
...
def run_6cond(encoder, decoder, dataloader, model_type, device, args):
    ...
    if args.output is None:
        args.output = f"scripts/rebuttal/samples/{args.label}_camus_6cond.csv"
