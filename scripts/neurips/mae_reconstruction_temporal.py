...
Usage:
  python scripts/neurips/mae_reconstruction_temporal.py \
    --checkpoint /path/to/checkpoint.pth \
    --test_csv /path/to/test_local.csv \
    --label mae_e50 \
    --save_dir scripts/neurips/mae_recon_vis \
...
def parse_args():
    ...
    p.add_argument("--save_dir", default="scripts/neurips/mae_recon_vis")
