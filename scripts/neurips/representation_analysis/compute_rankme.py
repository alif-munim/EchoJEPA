...
Usage:
    python scripts/neurips/compute_rankme.py path/to/clip_outputs.npz [--label NAME]
    python scripts/neurips/compute_rankme.py path/to/features.npz --feature-key embeddings
