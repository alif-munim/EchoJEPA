...
Usage:
    TMPDIR=/tmp LD_LIBRARY_PATH=/opt/conda/lib:$LD_LIBRARY_PATH \
        python scripts/neurips/umap_clean_vs_perturbed.py \
        --models pt50 \
        --perturbation depth_attenuation \
        --severity severe \
        --n_samples 200 \
        --device cuda:6 \
        --output scripts/neurips/samples/umap_clean_vs_perturbed.png
    ...
    TMPDIR=/tmp LD_LIBRARY_PATH=/opt/conda/lib:$LD_LIBRARY_PATH \
        ...
        --n_samples 200 \
        --device cuda:6 \
        --output scripts/neurips/samples/umap_clean_vs_perturbed_3x3.png
...
def main():
    ...
    parser.add_argument(
        "--output",
        default="scripts/neurips/samples/umap_clean_vs_perturbed.png",
