...
Usage:
    TMPDIR=/tmp LD_LIBRARY_PATH=/opt/conda/lib:$LD_LIBRARY_PATH \
        python scripts/neurips/information_probing.py \
        --models pt50 --device cuda:0 \
        --output scripts/neurips/samples/information_probing.png
"""
...
def main():
    ...
    parser.add_argument("--output", default="scripts/neurips/samples/information_probing.png")
