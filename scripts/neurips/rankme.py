...
Usage:
    python scripts/neurips/rankme.py \
        --models SALT-S2v1-e79 JEPA-IN21K-e100 MAE-L-e99 BYOL-L-e100 \
        --device cuda:0 --n_videos 500

    # Single model
    python scripts/neurips/rankme.py --models SALT-S2v1-e79 --device cuda:0
"""
...
def main():
    ...
    if args.output is None:
        os.makedirs("scripts/neurips/samples", exist_ok=True)
        args.output = "scripts/neurips/samples/rankme_salt.csv"
