...
Usage:
    ...
    TMPDIR=/tmp LD_LIBRARY_PATH=/opt/conda/lib:$LD_LIBRARY_PATH python scripts/neurips/noised_inference.py \
        --encoder_type vjepa \
...
def main():
    ...
    if args.output is None:
        args.output = f"scripts/neurips/samples/{args.label}_noised_inference.csv"
