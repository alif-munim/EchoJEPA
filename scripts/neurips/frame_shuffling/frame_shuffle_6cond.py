...
Usage:
    python scripts/neurips/frame_shuffle_6cond.py \
        --test_csv data/csv/echonet_dynamic_test_local.csv \
        --models JEPA-IN21K-e100 \
        --device cuda:0 \
        --output scripts/neurips/samples/6cond_JEPA_IN21K_e100.csv
"""
...
def main():
    ...
    if args.output is None:
        args.output = "scripts/neurips/samples/frame_shuffle_6cond_results.csv"
