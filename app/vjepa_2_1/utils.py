...
def load_checkpoint(
    ...
    if target_encoder is not None:
        ...
        pretrained_dict = checkpoint[target_key]
...
def init_video_model(
    ...
    if n_output_distillation is not None:
        encoder_kwargs["n_output_distillation"] = n_output_distillation
    encoder = video_vit.__dict__[model_name](**encoder_kwargs)
    ...
    predictor = vit_pred.__dict__["vit_predictor"](
        ...
        modality_embedding=modality_embedding,
        img_temporal_dim_size=img_temporal_dim_size,
        **({"n_output_distillation": n_output_distillation} if n_output_distillation is not None else {}),
    )
