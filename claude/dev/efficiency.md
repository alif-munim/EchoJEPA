...
## Final Recommendations — ALL ADOPTED (2026-03-13)
...
### What's Running (launched 06:55 UTC 2026-03-13)

**Job A** (GPUs 0-3, MASTER_PORT=29500):
1. TAPSE echojepa-l-k (fresh) — ~3.75h
2. TAPSE echomae (fresh) — ~3.75h
3. TAPSE panecho (fresh) — ~2.5h
4. LVEF echoprime (fresh) — ~5.0h
Total: ~15.3 hrs

**Job B** (GPUs 4-7, MASTER_PORT=29501):
1. LVEF echojepa-l-k (fresh) — ~3.75h
2. LVEF echojepa-l (fresh) — ~3.75h
3. LVEF echomae (fresh) — ~3.75h
4. LVEF panecho (fresh) — ~2.5h
Total: ~14.3 hrs

**ETA: ~22:00 UTC Mar 13** (wall = ~15 hrs from 06:55)
